...
import VerInfoCliente from './VerInfoCliente.jsx';
  ...
  return (
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.carouselContainer}>
          ...
          {visibleClientes.map((cliente) => (
            <div className={styles.card} key={cliente.id}>
              ...
              <div className={styles.buttonContainer}>
                ...
                <button onClick={() => setSelectedCliente(cliente)} className={`${styles.iconOnlyButton} ${styles.verButton}`}>
        ...
        <button className={styles.navButton} onClick={nextSlide} disabled={currentSlide === totalSlides - 1}> › </button>
      </div>
